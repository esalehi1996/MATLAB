...
% Last Modified by GUIDE v2.5 06-Jan-2016 08:36:17
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Val(1) = str2double(handles.edit2.String);
Val(2) = str2double(handles.edit4.String);
Val(3) = str2double(handles.edit5.String);
Val(4) = str2double(handles.edit6.String);
Val(5) = str2double(handles.edit7.String);
Val(6) = str2double(handles.edit8.String);

errtmp = str2double(handles.edit9.String)
if errtmp ~= 0
    Err(1) = errtmp;
else
...
errtmp = str2double(handles.edit10.String)
if errtmp ~= 0
    Err(2) = errtmp;
else
...
errtmp = str2double(handles.edit11.String)
if errtmp ~= 0
    Err(3) = errtmp;
else
...
errtmp = str2double(handles.edit12.String)
if errtmp ~= 0
    Err(4) = errtmp;
else
...
errtmp = str2double(handles.edit13.String)
if errtmp ~= 0
    Err(5) = errtmp;
else
    if handles.checkbox5.Value == 0
        Err(5) = -2;
    else
        Err(5) = -1;
    end
end
errtmp = str2double(handles.edit14.String)
if errtmp ~= 0
    Err(6) = errtmp;
else
    if handles.checkbox6.Value == 0
        Err(6) = -2;
    else
        Err(6) = -1;
    end
end
handles.text14.String = result(char(get(handles.edit1, 'String')), Val);
handles.text11.String = errval(char(get(handles.edit1, 'String')), Err, Val);
handles.text12.String = relerr(char(get(handles.edit1, 'String')), Err, Val);
